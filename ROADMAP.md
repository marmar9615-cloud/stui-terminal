...
- Charts for simple terminal-native visualization without pulling in a browser
  runtime.
- Richer dataframe support for browsing, formatting, and inspecting tabular data
  in terminal apps.
- Layout primitives for common app shapes such as rows, columns, panels, and
  side-by-side sections.
- Forms for grouping inputs and applying changes deliberately.
